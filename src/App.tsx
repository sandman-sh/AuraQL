...
export const App: React.FC = () => {
  ...
  return (
    <>
      ...
      {isInitializing && (
        <div className="fixed inset-0 z-50 bg-dark-950/95 backdrop-blur-md flex flex-col items-center justify-center text-center p-6 selection:bg-brand-500/30">
          ...
          <div className="w-48 h-1 bg-dark-900 rounded-none overflow-hidden border border-white/10">
